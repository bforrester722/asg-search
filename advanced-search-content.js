...
class ASGAdvancedSearchContent extends AppElement {
  ...
  __computeHidePrice(threshold) {
    return threshold === undefined ? false : true;
  }
...
window.customElements.define(ASGAdvancedSearchContent.is, ASGAdvancedSearchContent);
